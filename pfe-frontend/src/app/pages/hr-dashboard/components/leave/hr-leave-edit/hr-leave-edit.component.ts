...
@Component({
  selector: 'app-hr-leave-edit',
  template: `
    <div class="hr-leave-edit">
      ...
      <form [formGroup]="leaveForm" (ngSubmit)="onSubmit()" class="leave-form">
        ...
        <div class="form-actions">
          <button type="submit" class="btn-primary" [disabled]="!leaveForm.valid">Update Leave Type</button>
...
export class HrLeaveEditComponent implements OnInit {
  leaveForm: FormGroup;
  ...
  ngOnInit(): void {
    ...
    // TODO: Load leave type data using the ID
  ...
  onSubmit(): void {
    if (this.leaveForm.valid) {
      // TODO: Implement leave type update logic
